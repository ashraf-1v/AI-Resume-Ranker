...
class AdvancedAnalytics:
    ...
    def save_models(self, models_dir='models'):
        ...
        try:
            ...
            if self.skill_weights:
                ...
                print(f"✅ Skill weights saved: {filepath}")
    ...
    def load_models(self, models_dir='models'):
        ...
        try:
            ...
            if os.path.exists(filepath):
                ...
                print(f"✅ Best model loaded: {filepath}")
                loaded_any = True
            ...
            if os.path.exists(filepath):
                ...
                print(f"✅ Skill weights loaded: {filepath}")
                loaded_any = True
            ...
            if os.path.exists(filepath):
                ...
                print(f"✅ Performance metrics loaded: {filepath}")
                loaded_any = True
            ...
            if os.path.exists(filepath):
                ...
                print(f"✅ Pattern analysis loaded: {filepath}")
                loaded_any = True
            
            return loaded_any
            
        except Exception as e:
            print(f"⚠️ Error loading models (this is normal on first run): {e}")
            return False
    ...
    def build_hiring_prediction_model(self):
        ...
        print(f"📊 Building ML models with {len(df)} candidates")
